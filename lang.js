...
const english = {
    ...
    note: "**The E-commerce, Finance App & Thank You David may take time to initialize product samples and login due to the server used for the backend deployment. Check the Frontend Repository for more information."
}
